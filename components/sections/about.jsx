        ...
        <div className="grid grid-cols-1 items-center gap-8 sm:gap-10 lg:gap-12 lg:grid-cols-2">
          <div className="relative order-2 lg:order-1 mx-auto w-full max-w-sm sm:max-w-md lg:max-w-full">
            ...
            <div className="relative mx-auto aspect-square max-w-xs sm:max-w-sm md:max-w-md overflow-hidden rounded-lg shadow-lg">
              <div className="relative h-full w-full bg-gradient-to-tr from-blue-50 to-white">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center px-4 sm:px-6">
                    <div className="mb-4 sm:mb-6 mx-auto h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-blue-600 flex items-center justify-center">
                      <Heart size={32} className="sm:size-40" color="white" />
                    </div>
                    <h3 className="mb-2 text-lg sm:text-xl font-bold text-blue-800">Trusted Since 2010</h3>
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 h-24 w-24 sm:h-32 sm:w-32 rounded-lg bg-blue-600 hidden sm:block"></div>
            <div className="absolute -left-4 sm:-left-6 -top-4 sm:-top-6 h-24 w-24 sm:h-32 sm:w-32 rounded-lg bg-slate-200 hidden sm:block"></div>
            ...
            <div className="absolute -bottom-6 sm:-bottom-10 left-0 right-0 mx-auto w-4/5 rounded-lg bg-white p-3 sm:p-4 shadow-lg">
              <div className="grid grid-cols-3 gap-1 sm:gap-2 text-center">
                <div className="border-r border-slate-200 px-1 sm:px-2">
                  <p className="text-lg sm:text-2xl font-bold text-blue-600">10+</p>
                  <p className="text-[10px] sm:text-xs text-slate-600">Years Experience</p>
                </div>
                <div className="border-r border-slate-200 px-1 sm:px-2">
                  <p className="text-lg sm:text-2xl font-bold text-blue-600">5,000+</p>
          ...
          <div className="order-1 lg:order-2">
            <div className="mb-2 sm:mb-3 inline-flex items-center rounded-full border border-blue-100 bg-blue-50 px-2 py-1 sm:px-4 sm:py-1.5 text-xs sm:text-sm font-medium text-blue-600">
              <span className="mr-2 h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-blue-600"></span>
              About Our Company
            </div>
            ...
            <ul className="mb-6 sm:mb-8 grid grid-cols-1 gap-2 sm:gap-3 sm:grid-cols-2">
              {features.map((feature, index) => (
                <li key={index} className="flex items-center">
                  <CheckCircle className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 text-blue-600" />
